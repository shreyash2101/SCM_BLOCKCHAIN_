...
contract ProductManagement {
        ...
        returns (bytes32)
    {
        ...
        require(parts[part_hash].manufacturer == address(0), "Part already exists..");
    ...
    function buildProduct(
        ...
        require(products[product_hash].manufacturer == address(0),"Product already exists.." );
    ...
    function getParts(bytes32 product_hash) public view returns (bytes32[6] memory){
        ...
        require(products[product_hash].manufacturer != address(0),"product doesnot exist");
